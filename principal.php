...
<body class="bg-success">
    <nav class="navbar navbar-expand-md navbar-dark"><!--original: navbar-light-->
        <div class="container-fluid">
          <a class="navbar-brand" href="./mi-cuenta.html">Mi cuenta</a>
    ...
    <main class="index-main">
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
              ...
              <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content bg-dark"> <!--fondo negro para modal-->
                    <div class="modal-header">
                      <h1 class="modal-title fs-5" id="staticBackdropLabel">Regístro</h1>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      Regístrate gratis y participa en la mejor plataforma de juegos del mundo
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Paso</button>
                      <button type="button" class="btn btn-primary" id="quiero">Quiero registrarme</button>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section>
            <div class="contenedor-cuerpo">
                ...
                <div class="mambo">
                    <a href="./juego-ajedrez.html"><div class="juego">Próximamente Ajedrez</div></a>
                    <a href="./juego-ludo.html"><div class="juego">Próximamente Ludo</div></a>
                    <a href="./juego-poker.html"><div class="juego">Próximamente Poker</div></a>
                    <a href="./juego-truco.html"><div class="juego">Próximamente Truco</div></a>
                    <a href="./juego-monopolio.html"><div class="juego">Próximamente Monopolio</div></a>
                    <a href="./juego-uno.html"><div class="juego">Próximamente Uno</div></a>
                </div>
        ...
        <section>
            <div class="ingreso w-25">
                <button class="btn btn-danger" id="cerrarSes">Cerrar sesión</button>
                <br>
                <!--<button class="btn btn-info" id="ingreso">ingresa</button>-->
            </div>
        </section>
    </main>
    <footer>
        <div class="index-footer">
            <ul class="contacto">
                ...
                <a href="./terminos-in.html">términos y condiciones</a>
            </ul>
        </div>
    </footer>
    <script>
        ...
        juegos.forEach((juego) => {
            ...
            juego.style.backgroundColor = colorAleatorio;
        });
    </script>
